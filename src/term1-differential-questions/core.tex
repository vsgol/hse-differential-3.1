...
\newcommand\enablemath{
  ...
  \newcommand\cont{\ensuremath{\mathfrak{c}}\xspace}
  ...
  \declaretheorem[numberwithin=\ThmNamespace, name=Обозначения, style=thmstyle_def]{designations}
  ...
  \declaretheorem[numbered=no, name=Замечания, style=thmstyle_remark]{remarks}
  \declaretheorem[numbered=no, name=Замечание Лектописца, style=thmstyle_remark]{remark_author}
  ...
  \newcommand\ssep{\mid} % set separator

  \newcommand\ENABLEDMATH{YES}
}
\newcommand{\RomanNumeral}[1]
{\textup{\MakeUppercase{\romannumeral #1}}}
\def\abs#1{\left|#1\right|}
\def\norm#1{\left\|#1\right\|}
\def\toto#1{\underset{#1}\rightrightarrows}
\def\tou#1{\underset{#1}\to}
